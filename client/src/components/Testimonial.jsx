//we took the pre built reviews from the website 'prebuiltui'
        ...
        <div className="flex flex-col items-center text-center">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
                <div className="flex flex-col items-center bg-white px-3 py-8 rounded-lg border border-gray-300/80 max-w-[272px] text-sm text-center text-gray-500">
                    ...
                    <p>“Content AI has revolutionized our content creation process. It's like having a team of expert writers at our fingertips.”</p>
                ...
                <div className="flex flex-col items-center bg-white px-3 py-8 rounded-lg border border-gray-300/80 max-w-[272px] text-sm text-center text-gray-500">
                    ...
                    <p>“Content AI has transformed our content strategy. It's an indispensable tool for our team.”</p>
                ...
                <div className="flex flex-col items-center bg-white px-3 py-8 rounded-lg border border-gray-300/80 max-w-[272px] text-sm text-center text-gray-500">
                    ...
                    <p>“Content AI has been a game-changer for our marketing team. It's like having a personal content strategist.”</p>
                    <p className="text-lg text-gray-800 font-medium mt-5">Sarah Thompson</p>
